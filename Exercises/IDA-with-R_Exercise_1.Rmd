...
### Part A - Data Input
**A.1** Open a new R script file to write and save your code for the exercises. Save this file in a new directory (folder) of your local copy of the IDA-with-R GitHub repo, e.g., ```IDA-with-R-master/my_exercises/exercise_1```.
