...
3. Engine Displacement (in cubin inches)
...
### Part A - Data Input
**A.1** Open a new R script file to write and save your code for the exercises. 
...
**A.4** Use the ```head()``` function to look at the first few rows of the data and make sure it looks like it was correctly loaded. You can compare the output here to the raw data by opening the url in A.2.
